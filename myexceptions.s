...
teclado:
    ...
    beq $a0, ' ', comando_pausar # Pausa (<spacebar>)

    beq $a0, 10, comando_quitar # Quitar (<enter>)
    ...
    beq $a0, 'W', comando_mover # Arriba (A/a)
	beq $a0, 'w', comando_convertir_mayuscula

    beq $a0, 'S', comando_mover # Abajo (S/s)
    beq $a0, 's', comando_convertir_mayuscula

    beq $a0, 'A', comando_mover # Izquierda (A/a)
